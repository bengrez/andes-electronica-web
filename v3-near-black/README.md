# Andes Electrónica · build "Near Black"

Build pre-configurado para la paleta **Near Black** (casi negro + cobre · tono editorial oscuro). Pensado para subirse a una branch dedicada de GitHub Pages para review de stakeholders.

## Qué tiene de distinto este build

- La paleta queda **fijada** en `near-black`. Cualquier preferencia previa guardada en `localStorage` se sobreescribe en cada carga, así un stakeholder que viene de otra branch nunca queda atrapado en la paleta equivocada.
...
1. Crear una branch nueva (ej. `pages-near-black`).
